...
std::vector<Command> baseCommands = {
        ...
        {"functionreport",       functionreport,       &par.functionreport,       COMMAND_TAXONOMY | COMMAND_FORMAT_CONVERSION,
                "Generate GO annotation report / HTML viewer",
                NULL,
                "Jingi Yeo <jingiyeo@snu.ac.kr>",
                "<i:queryDB> <i:targetDB> <i:alignmentDB> <o:functionReport>",
                CITATION_TAXONOMY, {{"queryDB",      DbType::ACCESS_MODE_INPUT,  DbType::NEED_DATA, &DbValidator::allDb },
        ...
        {"goenrich",             goenrich,             &par.goenrich,             COMMAND_TAXONOMY | COMMAND_FORMAT_CONVERSION,
                "GO term enrichment analysis (Fisher's exact test) vs. full target DB background",
                NULL,
                "Jingi Yeo <jingiyeo@snu.ac.kr>",
                "<i:queryDB> <i:targetDB> <i:alignmentDB> <o:enrichDB>",
                CITATION_TAXONOMY, {{"queryDB",      DbType::ACCESS_MODE_INPUT,  DbType::NEED_DATA, &DbValidator::allDb },
                                    {"targetDB",     DbType::ACCESS_MODE_INPUT,  DbType::NEED_DATA, &DbValidator::allDb },
                                    {"alignmentDB",  DbType::ACCESS_MODE_INPUT,  DbType::NEED_DATA, &DbValidator::allDb },
