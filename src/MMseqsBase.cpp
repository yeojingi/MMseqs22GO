...
std::vector<Command> baseCommands = {
        ...
        {"functionreport",       functionreport,       &par.functionreport,       COMMAND_TAXONOMY | COMMAND_FORMAT_CONVERSION,
                ...
                CITATION_TAXONOMY, {{"seqTaxDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::allDb },
                                                           {"functionDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::allDb },
                                                           {"allignmentDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA,  &DbValidator::allDb },
